...
from agent.multi_agent.modifier_agent import detect_modification

from agent.tools.poi import search_poi, search_around, search_along_route, geocode, robust_geocode, AmapAPIError
from agent.tools.graph_planner import build_graph, shortest_path, decide_transport
...
def _run_modification(user_input: str, session: AgentSession,
    ...
    if change_type == "change_origin":
        ...
        from agent.multi_agent.poi_strategy_agent import SearchRegion, SearchStrategy
    ...
    from agent.multi_agent.types import UserProfile, IntentResult
