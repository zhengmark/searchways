...
class EnrichedInput:
    ...
    budget_hint: Optional[str] = None  # "low"|"medium"|"high"
...
class InputEnricher:
    ...
    @classmethod
    def enrich(cls, user_input: str, session_city: str = "", 
               session_keywords: str = "") -> EnrichedInput:
    ...
    @classmethod
    def _detect_budget(cls, text: str) -> Optional[str]:
