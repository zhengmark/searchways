...
class AnthropicProvider(LLMProvider):
    ...
    def _retry_request(self, headers: dict, payload: dict, timeout: int = 120) -> dict:
        ...
        for attempt in range(_MAX_RETRIES):
            try:
                ...
                if resp.status_code in (401, 403):
                    raise Exception(f"API authentication failed ({resp.status_code}), please check LLM_API_KEY")
